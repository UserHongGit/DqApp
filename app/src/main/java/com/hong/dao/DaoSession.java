...
//    private final BookmarkDao bookmarkDao;
    ...
    private final String TAG = DaoSession.class.getSimpleName()+"===================";

    public DaoSession(Database db, IdentityScopeType type, Map<Class<? extends AbstractDao<?, ?>>, DaoConfig>
            daoConfigMap) {
        super(db);
        Log.i(TAG, "DaoSession: _____   DaoSession构造器");
//
...
//
        Log.i(TAG, "DaoSession: ___"+daoConfigMap.toString()+"////"+daoConfigMap.get(MyTrendingLanguageDao.class));
