...
public class PicSelectActivity extends AppCompatActivity implements View.OnClickListener,
    ...
    private final static String TAG = PicSelectActivity.class.getSimpleName();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        FullyGridLayoutManager manager = new FullyGridLayoutManager(PicSelectActivity.this, 4, GridLayoutManager.VERTICAL, false);
        recyclerView.setLayoutManager(manager);
        adapter = new GridImageAdapter(PicSelectActivity.this, onAddPicClickListener);
            ...
            public void onItemClick(int position, View v) {
                if (selectList.size() > 0) {
                    ...
                    switch (mediaType) {
                        case 1:
                            // 预览图片 可自定长按保存路径
                            //PictureSelector.create(PicSelectActivity.this).themeStyle(themeId).externalPicturePreview(position, "/custom_file", selectList);
                            PictureSelector.create(PicSelectActivity.this).themeStyle(themeId).openExternalPreview(position, selectList);
                            break;
                        case 2:
                            // 预览视频
                            PictureSelector.create(PicSelectActivity.this).externalPictureVideo(media.getPath());
                            break;
                        case 3:
                            // 预览音频
                            PictureSelector.create(PicSelectActivity.this).externalPictureAudio(media.getPath());
                            break;
                    }
                }
            }
    ...
    private GridImageAdapter.onAddPicClickListener onAddPicClickListener = new GridImageAdapter.onAddPicClickListener() {
        ...
        public void onAddPicClick() {
            ...
            if (mode) {
                ...
                PictureSelector.create(PicSelectActivity.this)
